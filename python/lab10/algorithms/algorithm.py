...
from .utils import np_array, static_vars, Logger, DummyLogger, Picker
...
class BaseEvolutionAlgo:
    def __init__(
        ...
        **kwargs,
        ...
        self.logger = (
            Logger(
                columns=["solution", "best_score", "worst_score", "median_score"],
                **logger_kwargs,
            )
            if log
            else DummyLogger()
    ...
    def generate_population(self, n=None):
        ...
        methods = h_politics.pop("methods")
